...
public class Player extends Character {
	...
	/**
	 * Ends the double jumping for the player and resets the necessary
	 * variables.
	 */
	...
	/**
	 * Gets the Location array containing the coordinates for each corner of the
	 * player.
	 */
	@Override
	...
	/**
	 * Changes the color based on the number of lives left Green = 3 lives left
	 * Yellow = 2 lives left Red = 1 life left
	 * 
	 * @param lives
	 *            int lives left
	 */
