...
public class Location
{
  ...
  /**
   * Create a new Location from the x and y coordinates from the passed Location.
   * 
   * @param location
  ...
  /**
   * String representation in the form (###.#, ###.#) where the first value is the x coordinate and
